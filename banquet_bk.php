...
if (!in_array($user_role, ['admin', 'banquet_staff'])) {
                        ...
                        <tr class="project-header-row <?= $has_drafts ? 'has-sub' : '' ?>" data-pid="<?= $pid ?>">
                            ...
                            <td>
                                <div class="text-dark small text-wrap" style="max-width: 250px;">
                                    <?= nl2br(htmlspecialchars($master['banquet_style'] ?: '-')); ?>
                                </div>
                            </td>
                            <td>
                    ...
                    <div class="card-body p-3">
                        ...
                        <div class="mb-2">
                            ...
                            <div class="bg-light p-2 rounded mb-2 small">
                                <strong class="d-block mb-1 text-gold"><i class="bi bi-calendar-check me-1"></i>การจัดงานเลี้ยง:</strong>
                                <div class="text-secondary"><?= nl2br(htmlspecialchars($master['banquet_style'] ?: '-')); ?></div>
                            </div>
                        </div>
...
<script>
    ...
    function refreshTable() {
        ...
        fetch('api/fetch_banquet_table.php?type=bk')
            .then(res => res.text())
            .then(html => {
