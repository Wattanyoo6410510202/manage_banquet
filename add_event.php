                    ...
                    <div style="width: 100%; max-width: 450px;">
                        <div class="d-flex align-items-center justify-content-end">
                            ...
                            if ($current_role !== 'viewer'):
                                ?>
                                <button type="button" class="btn btn-outline-success btn-sm px-3 flex-shrink-0 me-2" id="pickupImportBtn">
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-lg-4">
                        <div class="p-3 rounded-4 bg-white border h-100">
                            ...
                            <input type="hidden" id="pickupQuoteNo" value="<?= htmlspecialchars($quote_data['quote_no'] ?? '') ?>">
                            <div class="mb-2">
...
<script>
    ...
    (function initPickupImport() {
        ...
        // เพราะ 2 แท็บนี้ใช้โครงสร้างตารางคนละแบบกับ add_quote.php/edit_quotation.php
        ...
        // เลขที่ใบเสนอราคาที่ผูกกับฟังก์ชันนี้ (ถ้าสร้างมาจากใบเสนอราคา)
