                        ...
                        <tr>
                            ...
                            <td>
                                <div class="text-dark small text-wrap" style="max-width: 250px;">
                                    <?= nl2br(htmlspecialchars($row['equipment'] ?: '-')); ?>
                                </div>
                            </td>
                            <td>
                ...
                <div class="card mb-3 border-0 shadow-sm" style="border-radius: 12px;">
                    <div class="card-body p-3">
                        ...
                        <div class="bg-light p-2 rounded mb-2 small">
                            <strong class="d-block mb-1">งานช่าง:</strong>
                            <?= nl2br(htmlspecialchars($row['equipment'] ?: '-')); ?>
                        </div>
...
<script>
    function showEventDetail(title, functionId) {
        ...
        // บังคับให้เป็น role technician เพื่อให้แสดงเฉพาะส่วนที่เกี่ยวข้อง
    ...
    function loadEventInfoModal(functionId, userRole) {
        fetch(`api/get_modal_data.php?id=${functionId}`)
            ...
            .then(response => {
                            ...
                            <div class="col-md-12">
                                <div class="card h-100 shadow-sm border-0 bg-light mb-3">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <textarea name="banquet_style" id="bk_textarea" class="form-control mb-2" placeholder="การจัดงานเลี้ยง" readonly>${data.banquet_style || ''}</textarea>
                ...
                ['mt_textarea'].forEach(textareaId => {
            ...
            .then(html => {
                ...
                if (filteredRows) {
                    document.getElementById('financeContainer').innerHTML = `
                        <h6 class="fw-bold mb-3">รายการการเงิน (แผนกช่าง)</h6>
